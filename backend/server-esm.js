...
import { errorHandler, notFoundHandler, gracefulShutdown } from './middleware/errorHandler.js';
...
try {
  ...
  const swaggerModule2 = await import('./swagger.js');
  swaggerSpecs = swaggerModule2.default;
} catch (error) {
...
if (config.server.nodeEnv !== 'test') {
  const server = app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log('🚀 BOOKING4U INTEGRATED SERVER STARTED (ES MODULES)');
    console.log('='.repeat(80));
